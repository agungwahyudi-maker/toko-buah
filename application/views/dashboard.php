    ...
    <div id="carouselExampleInterval" class="carousel slide" data-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item" data-interval="10000">
                <img src="<?php echo base_url('uploads/slide/slide11.jpg') ?>" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item" data-interval="2000">
                <img src="<?php echo base_url('uploads/slide/slide31.jpg') ?>" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item active">
                <img src="<?php echo base_url('uploads/slide/slide21.jpg') ?>" class="d-block w-100" alt="...">
            </div>
        </div>
